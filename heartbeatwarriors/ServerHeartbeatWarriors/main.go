//ServerHeartbeatWarriors main.go
...
const (
	...
	readerProgramPath   = "/app/ReaderHeartbeatWarriors" // Ensure this path is correct
)
...
func main() {
	...
	setupHeartbeatMonitoring(serverHeartbeatFile, readerHeartbeatFile, "Reader", readerProgramPath)
